...
public class DateUtil {
    ...
    public static String parseStrToStr(String strTime, String timeFromat) {
        try {
            DateFormat dateFormat = new SimpleDateFormat(timeFromat);
            return parseDateToStr(dateFormat.parse(strTime) ,timeFromat ,new Date());
        } catch (Exception e) {
            return new SimpleDateFormat(timeFromat).format(new Date());
        }
    }
     ...
     * @return
     */
    public static String getPassTime(Integer lastNumber , String timeFromat) {
        Calendar calendar = Calendar.getInstance();
        calendar.add(Calendar.DATE, lastNumber);
        return parseDateToStr(calendar.getTime(), timeFromat);
    }
     ...
     * @return
     */
    public static String getGMTDate(String time ,String timeFormat) {
        Calendar cd = Calendar.getInstance();
        SimpleDateFormat sdf = new SimpleDateFormat("EEE MMM d yyyy 00:00:00", Locale.ENGLISH);
        sdf.setTimeZone(TimeZone.getTimeZone("GMT+0800")); // 设置时区为GMT
        return sdf.format(DateUtil.parseStrToDate(time ,timeFormat));

    }
    public static void main(String[] args) throws ParseException {
//        System.out.println(getPassTime(-1, DATE_FORMAT_YY_MM_DD));
//        System.out.println(timeKit("2019-01-24"));
